...
class Application extends egg.Application {
  ...
  onGrpcServer(httpServer) {
    ...
    const obeliskConfig = this.config.obelisk || {};
    if (obeliskConfig.listen === false || !this.proto) return;
    ...
    // obeliskConfig.gRPCServerOptions: https://grpc.github.io/grpc/core/group__grpc__arg__keys.html
    const server = new grpc.Server(obeliskConfig.gRPCServerOptions);
    ...
    // 监听、启动
    const listenConfig = Object.assign({ hostname: '0.0.0.0', port: 50051 }, obeliskConfig.listen);
